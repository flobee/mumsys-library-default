 ...
 * @see lib/mumsys2/Mumsys_Geolocation_Item.php
 * @filesource
...
/**
 * Geolocation item containing all informations which may come from a location service or a storrage.
 *
...
class Mumsys_Geolocation_Item_Default
{
     ...
     * - 'publisher' possible properties are: 'id', 'name', 'lastupdate', 'language', 'copyright'
     * - 'location' possible properties are:  'id', 'thatid', 'street', 'areaCode', 'city', 'region', 'countryName',
     * 'countryCode', 'fromattedAddr', 'continentCode', 'sunrise', 'sunset', 'latitude', 'longitude', 'altitude',
     * 'tz_offset', 'tz_name', 'dmaCode', 'currencyCode', 'currencySymbol', 'currencyConverter', 'phonePrefixCode'
     * @param boolean $strictlyAll Flag to set all possible values or just the data you have.
     */
    public function __construct( array $params = array(), bool $strictlyAll = false )
    {
        if ( $strictlyAll ) {
     ...
     * - 'id' Unique identifier for the publisher on this system/enviroment/serverfarm...
     * - 'name' string Name of the publisher
     * - 'lastupdate' int Unix timestamp UTC
     * - 'language' string  Language code or locale all text data belongs to in description or 'name' value
     * - 'copyright' string Copyright notes, terms, required or important informations
     */
     ...
     * - 'id' string Value which belongs to this system/enviroment. The unique id for this location at this end.
     * - 'thatid' string Value which belongs to the publisher. The unique id for this location at their end
     * - 'street' string Name of the street including house number
     * - 'areaCode' string The Postal Code, FSA or Zip Code.
     * - 'region' string Name of the region. State in a country. Eg. "Bundesland" or "California" in the USA
     * - 'city' string Name of the location
     * - 'countryName' string Full name of the country
     * - 'countryCode' string Code of the country. Country code by ISO 3166. E.g.: DE, US, FR, AT, CH, RU, UA
     * - 'fromattedAddr' string Complete formatted address
     * - 'continentCode' string Code of the continent. Eg.: AF -Africa, AN - Antarctica, AS - Asia, EU - Europe,
     * NA - North america, OC - Oceania, SA - South america.
     * - 'sunrise' integer Unix timestamp (local time) of the timezone this location belong to
     * - 'sunset' integer Unix timestamp (local time) of the timezone this location belong to
