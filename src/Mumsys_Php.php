...
class Mumsys_Php
{
     ...
     * @param boolean $binType IEC prefix calculation or not. Not implemented for false.
     *
    ...
    public static function str2bytes( $value , $binType=true)
    {
        ...
        if ( empty($value) ) {
            ...
            switch ( $last )
            {
                ...
                case 'm':
                case 'M':
                    return (int) $value * 1048576; // pow(2,20)
                    break;

                case 'g':
                case 'G':
                    $value = $value * 1073741824; // pow(2,30)
                    break;

                case 't':
                case 'T':
                    $value = $value * 1099511627776; // pow(2,40)
                    break;
