...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2016-02-16 at 20:29:47.
 */
class Mumsys_Db_Driver_Mysql_MysqlTest extends PHPUnit_Framework_TestCase
{
     ...
     * @covers Mumsys_Db_Driver_Mysql_Mysql::_setError
     */
    public function testConnect()
    {
        $config = $this->_configs['database'];

        $this->assertTrue( is_resource( $this->_object->connect() ) );

        // compression
        $config['compress'] = true;
        $object = Mumsys_Db_Factory::getInstance($config);
        $this->assertTrue( is_resource( $object->connect() ) );
        ...
        $this->setExpectedException(
            'Mumsys_Db_Exception',
            'Connection to database failed. Please check configuration. Connection timed out'
        );
        $object->connect();
    }
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::close
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::setCharset
     * @covers Mumsys_Db_Driver_Mysql_Mysql::getCharset
     */
    public function testGetSetCharset()
    {
        ...
        $this->assertEquals('utf8', $actual1);
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::selectDB
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::showDBs
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::stat
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::query
     * @covers Mumsys_Db_Driver_Mysql_Mysql::_setError
     */
    public function testQuery()
    {
        ...
        $this->assertInstanceOf('Mumsys_Db_Driver_Mysql_Mysql_Result',$actual1);
        $this->assertInstanceOf('Mumsys_Db_Driver_Mysql_Mysql_Result',$actual2);
        $this->assertFalse($actual3);

        // for code coverage
        $this->_object->close();
        $actual4 = $this->_object->query('SELECT 1,2,3');
        $this->assertInstanceOf('Mumsys_Db_Driver_Mysql_Mysql_Result',$actual4);
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::queryUnbuffered
     * @covers Mumsys_Db_Driver_Mysql_Mysql::setThrowErrors
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::isError
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::sqlError
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::sqlErrno
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::fetchData
     */
     ...
     * @covers Mumsys_Db_Driver_Mysql_Mysql::compileQueryExpression
     */
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::sqlImplode
     * @covers Mumsys_Db_Driver_Mysql_Mysql::_setError
     *
...
//            'suggested_Test' => 'IS NOT NULL', // ->
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::getServerInfo
     *
     * Possible:
     * 10.0.17-MariaDB-log
    ...
    /**
     * @covers Mumsys_Db_Driver_Mysql_Mysql::escape
     * @covers Mumsys_Db_Driver_Mysql_Mysql::_setError
     */
...
//    }
     ...
     * @covers Mumsys_Db_Driver_Mysql_Mysql::quote
     */
