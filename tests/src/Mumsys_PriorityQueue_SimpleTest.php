...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2016-03-20 at 21:11:26.
 */
...
//        $o->add('AAA', 'AAA');
//        $o->add('BBB', 'BBB');
//        $o->add('CCC', 'CCC', 'before', 'AAA');
//        $o->add('DDD', 'DDD', 'before', 'BBB');
//        $o->add('EEE', 'EEE', 'after', 'BBB');
//        $o->add('Fucking cool man', 'Fucking cool man');
//        foreach($o->getQueue() as $key=>$node) {
//            echo $key . PHP_EOL;
//        }
    ...
    public function testAddSimpleExeption()
    {
        ...
        $this->setExpectedException('Mumsys_Exception', 'Identifier "AAA" already set');
        $this->_object->add('AAA', 'AAA');
    }
    ...
    {
        $this->setExpectedException('Mumsys_Exception', 'Position way "WayNotExists" not implemented');
